...
RSpec.describe 'Updating a book', type: :feature do
  scenario 'valid inputs' do
    ...
    fill_in 'Published Date', with:'January 1 2000'
    fill_in 'Author', with: "J. K. Rowling"
  ...
  scenario 'invalid inputs' do
      harryp = Book.create!(title: 'Harrpy Potter The Chamber of Secrets', price: '14.99', published_date: 'January 16 2003', author: 'J. K. Rowling')
      visit edit_book_path(id: harryp.id)
      fill_in 'Title', with: ''
      fill_in 'Price', with: ""
      fill_in 'Published Date', with: ""
